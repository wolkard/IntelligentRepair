...
<html>
	...
	<body>
	    ...
	    <div class="mui-content">
	        ...
	        <div class="mui-card">
	        	<div class="mui-card-header" style="color: #FFFFFF;background-color: rgba(254, 201, 16, 1);">可接取任务</div>
	        	
						<ul id="allInformation" class="mui-table-view">
							<!--任务模板-->
							<!--任务模板-->
...
<script>
//	需要ajax的地方：
//	1.打开这个页面的时候需要返回所有可接取任务的详细信息。包括图片url
		...
		$.ajax({
			...
			success:function(data){
				...
				for(var i=0 ; i<data['data'].length ; i+=1){
					...
					allInformation+='<span class="mui-badge mui-badge-green mui-pull-right">可接取</span></a></li>';
				}
